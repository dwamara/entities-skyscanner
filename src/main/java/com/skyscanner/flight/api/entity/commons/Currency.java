...
public class Currency {
	...
	@SerializedName("ThousandsSeparator") @Expose private String thousandsSeparator;
	@SerializedName("DecimalSeparator") @Expose private String decimalSeparator;
	@SerializedName("SymbolOnLeft") @Expose private Boolean symbolOnLeft;
	@SerializedName("SpaceBetweenAmountAndSymbol") @Expose private Boolean spaceBetweenAmountAndSymbol;
	@SerializedName("RoundingCoefficient") @Expose private Integer roundingCoefficient;
	@SerializedName("DecimalDigits") @Expose private Integer decimalDigits;
